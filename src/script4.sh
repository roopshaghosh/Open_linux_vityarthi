...
# Usage: ./script4_log_analyzer_final /path/to/logfile [KEYWORD]
# Example: ./script4_log_analyzer_final /var/log/syslog error
# ============================================================
...
while IFS= read -r LINE; do
    ...
    if echo "$LINE" | grep -iq "$KEYWORD"; then
       ...
       MATCH_LINES+=("Line $LINE_NO: $LINE")      # Add to match array
    fi
...
if [ $COUNT -gt 0 ]; then
    ...
    echo "  Suggestion: Try keywords like ERROR, WARNING, FAIL": ./$(basename $0) $LOGFILE WARNING"
fi
echo "---------------------------------------------------------------"
echo "  Report generated by: Roopsha Ghosh"
echo "  OSS Capstone Project - Log Analyzer"
echo "==============================================================="
echo "================================================================"
